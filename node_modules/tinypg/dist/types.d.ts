...
export declare type HookCollection = {
...
export declare type TinyPgPrimitive = string | number | boolean | object | Buffer | Date;
export declare type TinyPgParams = undefined | null | object | {
